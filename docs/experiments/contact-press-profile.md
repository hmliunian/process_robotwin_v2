...
在同一 `target_only_20_v2` contact_press 子集（120 episodes）上，旧流程最终完成
...
| 实验 | 输出/判定 | 状态 |
| --- | --- | --- |
| Stage 1（120 episodes） | 6 个 contact/action-site task 均为 20/20；合计 `120/120` | 已完成；只证明时间线和 sparse-frame 合同通过 |
